...
#ifndef STYLECAMERA_SWIFT_H
#define STYLECAMERA_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="StyleCamera",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC11StyleCamera12CameraEngine")
...
@interface CameraEngine (SWIFT_EXTENSION(StyleCamera)) <AVCapturePhotoCaptureDelegate>
...
@interface CameraEngine (SWIFT_EXTENSION(StyleCamera)) <AVCaptureVideoDataOutputSampleBufferDelegate>
